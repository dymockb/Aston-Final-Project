    ...
    public void displayScreen() throws NoSuchElementException {
        ...
        while(viewingPerformance){
            ...
            try {
                ...
                System.out.println("performance seats ERROR - end of test file.");
            ...
            if (userInput.equals("b")){
                ...
                } else if (seatingAreaSelected.equals("error")){
                    
                    System.out.println("seatingArea ERROR - end of test file.");
                    noUserTextFileErrors = false;
                ...
                StaticPrinter.invalidCommand("ViewPerformance");
